...
with mlflow.start_run():
    # Set MLFlow tag to differentiate the model approaches
    ...
    # Define Data Capture Client
    feature_names = list(X.columns)
    target_name = ['quality']
    data_capture_client = DataCaptureClient(feature_names, target_name)

    # Create a custom MLflow model class
    ...
    # Wrap the model
    wrapped_model = WineQualityModel(gbr)
